...
open class FolioReaderCenter: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func configureNavBarButtons() {
        ...
        let bookmark = UIBarButtonItem(image: fontIcon, style: .plain, target: self, action: #selector(bookmarkPage))
        if let _ = UserDefaults.standard.object(forKey: "BookmarkPage") {
            bookmark.image = audioIcon
        }
    ...
    func bookmarkPage() {
        UserDefaults.standard.set(currentPage?.pageNumber, forKey: "BookmarkPage")
